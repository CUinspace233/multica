...
// Fork note: this function is hand-merged from fork/main, since the upstream
// sqlc input did not include a `ListAllWorkspacesAdmin` query. The companion
// SQL lives at server/pkg/db/queries/workspace.sql; if that file gets
// regenerated in the fork, run `sqlc generate` inside apps/server to refresh
// this block.
