...
-- Renumbered from 165 → 226 → 274 → 350 across the four weekly upstream syncs
-- (2026-07-12, 2026-07-26, 2026-08-10, 2026-08-18) because each sync upstream
-- landed its own 226_chat_message_channel_ingested, 274_task_token_workspace_id_
...
-- already applied it as 165 / 226 / 274; CREATE INDEX CONCURRENTLY IF NOT
-- EXISTS makes that idempotent.
